<!-- <li class="active">トップ<span class="divider">/</span></li> -->
<li><a href="/">トップ</a><?php if (!isset($sidemenu)) { echo '<span class="divider">/</span>'; } ?></a></li>
<li><a href="/maintenance">ニュース</a><?php if (!isset($sidemenu)) { echo '<span class="divider">/</span>'; } ?></a></li>
